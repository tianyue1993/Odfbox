...
public class BoxDefineHandler extends BaseResponseHandler {

    public BoxDefineHandler() {
        this(DEFAULT_CHARSET);
    }

    public BoxDefineHandler(String encoding) {
        super(encoding);
    }

    public void onSuccess(BoxDefineList boxList) {
            ...
            public void run() {
                postRunnable(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            if (statusCode == 200) {
                                onSuccess(JSON.parseObject(response.toString(), BoxDefineList.class));
                            } else {
