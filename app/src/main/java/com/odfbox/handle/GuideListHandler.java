...
public class GuideListHandler extends BaseResponseHandler {

    public GuideListHandler() {
        this(DEFAULT_CHARSET);
    }

    public GuideListHandler(String encoding) {
        super(encoding);
    }
            ...
            public void run() {
                postRunnable(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            if (statusCode == 200) {
                                onSuccess(JSON.parseObject(response.toString(), GuideList.class));
                            } else {
