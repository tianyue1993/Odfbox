...
public class WorkOrderHandler extends BaseResponseHandler {

    public WorkOrderHandler() {
        this(DEFAULT_CHARSET);
    }

    public WorkOrderHandler(String encoding) {
        super(encoding);
    }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                postRunnable(new Runnable() {
                    ...
                    public void run() {
                        if (statusCode == 200) {
                            onSuccess(JSON.parseObject(response.toString(), WorkOrderList.class));
                        }
                    }
                });
            }
